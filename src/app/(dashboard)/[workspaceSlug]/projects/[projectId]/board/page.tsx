    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex flex-1 items-center justify-center">
        <div className="text-center">
          <LayoutPanelTop className="text-muted-foreground/30 mx-auto mb-4 size-16" />
          <h3 className="text-lg font-semibold">Kanban Board</h3>
          <p className="text-muted-foreground mt-1 text-sm">
            Drag and drop issues across status columns.
          </p>
          <p className="text-muted-foreground/50 mt-8 text-xs">
            Full kanban board with dnd-kit will be built in Phase 10.
          </p>
        </div>
      </div>
    </div>

    ...
    <div className="flex h-full flex-col">
      ...
      <div className="flex flex-1 items-center justify-center">
        <div className="text-center">
          <List className="text-muted-foreground/30 mx-auto mb-4 size-16" />
          <h3 className="text-lg font-semibold">List View</h3>
          <p className="text-muted-foreground mt-1 text-sm">
            View and edit issues in a spreadsheet-like table.
          </p>
          <p className="text-muted-foreground/50 mt-8 text-xs">
            Full list view with inline editing will be built in Phase 11.
          </p>
        </div>
      </div>
    </div>
